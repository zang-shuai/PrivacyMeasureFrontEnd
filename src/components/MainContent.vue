      ...
      <div class="card-body">
        ...
        <FormField
          ...
          <el-form-item label="离散输入域:">
            <el-input id="discrete_domain_input" v-model="formData.discrete_domain.content" placeholder="不同值以逗号分隔" />
          </el-form-item>
        </FormField>
              ...
              <div v-if="showField('value_domain')" id="value_domain" class="mb-2">
                      <div class="d-flex align-items-center">
                        <label for="value_domain_input" class="form-label text-muted mb-2"
                          style="white-space: nowrap">value的输入域： <span>[-1, 1]</span></label>
                      </div>
              </div>
            </div>
          </el-form-item>
            ...
            <div class="content">
              ...
              <div v-show="showField('code_file')" id="code_file" class="mb-2">
                <div class="d-flex align-items-center">
                  ...
                  <el-input type="textarea" id="code_file_input" name="code" cols="100"
              ...
              <div v-if="showField('ob_format')" id="ob_format" class="mb-2">
                <div class="d-flex align-items-center">
                  <label for="ob_format_input" class="form-label text-muted mb-2"
                    style="white-space: nowrap">黑盒算法输入参数格式：<span>隐私预算, 输入域, 数据, 测试输入数量</span></label>
                </div>
                <div class="d-flex align-items-center">
                  <label for="ob_format_output" class="form-label text-muted mb-2"
                    style="white-space: nowrap">黑盒算法输出格式：<span>
                      <pre>
                  {
                  // 编码值列表
                  "encode_list": [...],
